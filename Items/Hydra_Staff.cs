...
#pragma warning restore 619
    ...
    public class Hydra_Nebula : ModProjectile {
        ...
        public override void AI() {
            ...
            float headDist = 24 * (heads == 1 ? -1 : heads == 0 ? 0 : heads-1);
            idlePosition.X -= (48f + headDist) * player.direction;
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor) {
            ...
            DrawData data = new DrawData(topJawTexture, projectile.Center-Main.screenPosition+off, new Rectangle(0, 0, 62, 28), Color.White, rotation-j, new Vector2(32,20), new Vector2(projectile.scale), spriteEffects, 0);
            data.shader = 87;
            data.Draw(spriteBatch);
            data = new DrawData(bottomJawTexture, projectile.Center - Main.screenPosition+off, new Rectangle(0, 0, 62, 28), Color.White, rotation + j, new Vector2(32, 20), projectile.scale, spriteEffects, 0);
